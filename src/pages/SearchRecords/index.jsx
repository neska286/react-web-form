...
const SearchRecordsPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        return await axios.post('http://150.230.49.47:8080/api/v1/integration/focal/screen/individual', payload)
            .then((response) => {
    ...
    return (
        ...
        <div className="container">
            <div className='col-md-12 mt-3 mb-3'>
                ...
                <button className="btn bg-secondary text-light w-50" onClick={handleDrawerOpen}>Search Form</button>
            </div>
            <hr />
